                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="bg-[#0A1931]/60 backdrop-blur-xl border border-brand-accent/20 rounded-[2.5rem] p-8 md:p-16 shadow-[0_0_80px_rgba(64,224,208,0.1)] text-center animate-fade-in-up">
                                ...
                                <div className="space-y-6 text-gray-300 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto font-medium">
                                    <p>
                                        Tu acceso al <span className="text-white font-bold">Sistema de Ejecución</span> ha sido validado satisfactoriamente.
                                    </p>
                                    <p>
                                        Has tomado la decisión que separa a los apostadores de los <span className="text-brand-accent font-bold">Traders Profesionales</span>. En TradeVision Latam entregamos metodología y rigor técnico. 
                                    </p>
                                    <p className="text-sm md:text-base opacity-80">
                                        Tu formación ha sido habilitada y un correo con credenciales de acceso está en camino. Por favor, revisa tu bandeja de entrada (y carpeta de spam).
                                    </p>
                                </div>
                                ...
                                <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
                                    <a 
                                        href="https://whop.com/joined/tradevisionlatam/comunidad-vip-trade-vision-latam-7weJ9knCrgvp79/app/"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="flex items-center justify-center gap-3 bg-brand-accent text-brand-primary font-black py-5 px-8 rounded-2xl text-base uppercase tracking-widest hover:bg-white transition-all transform hover:scale-[1.02] shadow-lg shadow-brand-accent/20 group"
                                    >
                                        <FaRocket className="text-xl group-hover:rotate-12 transition-transform" />
                                        ACCEDER A COMUNIDAD VIP (WHOP)
                                    </a>
                                    ...
                                    <a 
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="flex items-center justify-center gap-3 bg-transparent border-2 border-white/20 text-white font-black py-5 px-8 rounded-2xl text-base uppercase tracking-widest hover:bg-white/10 transition-all transform hover:scale-[1.02] group"
                                    >
                                        <FaTelegram className="text-xl text-[#0088cc] group-hover:scale-110 transition-transform" />
                                        UNIRSE AL TELEGRAM VIP
                                    </a>
                                </div>
