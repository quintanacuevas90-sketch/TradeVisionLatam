...
const ForexElitePage: React.FC = () => {
    ...
    const faqs = [
        ...
        { q: "¿Qué recibo con el pago de $499 USD?", a: "Recibes acceso vitalicio al programa de videos, acceso a la comunidad privada de Discord/Telegram para alumnos Élite, y soporte directo de nuestro equipo de mentores para tus análisis." },
            ...
            <main className="pt-20">
                ...
                <AnimatedSection className="relative min-h-[80vh] flex items-center justify-center text-center overflow-hidden bg-brand-primary">
                    ...
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-16 sm:py-20">
                        ...
                        <SocialProofWidget variant="forex" className="mb-6" />
