...
const CollaborationTermsModal: React.FC<{ onClose: () => void }> = ({ onClose }) => {
    return (
        <Modal onClose={onClose} title="Acuerdo de Colaboración y Ética (TradeVision Latam)">
            <div className="text-gray-700 dark:text-gray-300 space-y-4 text-sm">
                <p className="font-bold">PREÁMBULO:</p>
                <p>Al enviar esta solicitud, usted (en adelante, "El Colaborador") busca unirse al ecosistema profesional de TradeVision Latam (en adelante, "La Academia"). Esta no es una oferta de empleo, sino una alianza estratégica basada en el rendimiento, la disciplina y el cumplimiento estricto de nuestra cultura de marca.</p>
                ...
                <p>La cultura de TradeVision Latam se basa en la transparencia y la honestidad. Por lo tanto, queda ESTRICTAMENTE PROHIBIDO que El Colaborador:</p>
                ...
                <ul className="list-disc list-inside pl-4 space-y-1">
                    ...
                    <li>Esto incluye la eliminación permanente del programa de afiliados (cancelando comisiones pendientes), la revocación de toda formación gratuita (Cursos Premium) y la expulsión de todas las comunidades privadas de TradeVision (Telegram y Discord).</li>
                </ul>
