...
const PremiumCoursesCtaSection: React.FC<PremiumCoursesCtaSectionProps> = ({ onOpenModal }) => {
    return (
        <AnimatedSection className="bg-brand-primary">
             <div className="py-20 bg-white/5">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-gray-300 text-lg max-w-2xl mx-auto mb-8">Accede a nuestra formación élite y aprende las estrategias que usan los profesionales.</p>
                    <button
                        onClick={() => onOpenModal('premium-courses')}
