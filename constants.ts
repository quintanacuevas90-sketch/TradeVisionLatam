...
export const TICKER_MESSAGES: string[] = [
    ...
    "🌟 Afiliados Transparentes: Registra tu cuenta broker con TRADEVISION LATAM y apoya nuestra plataforma educativa. ¡Transparencia total!",
...
export const TESTIMONIALS: Testimonial[] = [
    ...
    },
    {
        ...
        quote: "Incluso en tiempos difíciles, la educación de TradeVision Latam me ha dado una nueva habilidad. Los mentores son excelentes.",
        location: "Venezuela",
    ...
    {
        name: "Lucas Giménez",
        quote: "TradeVision Latam tiene los mejores mentores, sin duda. El valor que aportan en los cursos premium es increíble.",
        location: "Argentina",
        flagUrl: "https://flagcdn.com/w40/ar.png"
    },
    {
...
export const BLOG_POSTS: Post[] = [
    {
        ...
        excerpt: "José Quintana, Asesor Principal, explica qué son las opciones binarias, sus altos riesgos (falta de regulación) y por qué TradeVision Latam las usa solo como herramienta educativa (demos).",
        ...
        content: `
            ...
            <h2 class="text-2xl font-bold text-brand-primary dark:text-white mt-6 mb-3">Cómo Operar Binarias (El Método TradeVision Latam)</h2>
    ...
    },
    {
        ...
        content: `
            ...
            <p>Cuando el mercado está "atrapado" (sea en un rango de 1 hora o en una década macroeconómica), debes cambiar tu psicología y tu estrategia. En TradeVision Latam, aplicamos esta disciplina:</p>
            ...
            <h3 class="text-xl font-bold text-brand-primary dark:text-white mt-4 mb-2">Consejos Tácticos (El Método TradeVision Latam)</h3>
            ...
            <p>El trader profesional de TradeVision Latam entiende esto. Deja de centrarse en las noticias y se enfoca en la estructura de liquidez. En lugar de perseguir tendencias obvias, espera pacientemente la manipulación institucional. Si el mercado está estancado, no es una señal de fortaleza; es una advertencia de que las "Ballenas" están preparando su próximo movimiento.</p>
    ...
    },
    {
        ...
        content: `
            ...
            <h2 class="text-2xl font-bold text-brand-primary dark:text-white mt-6 mb-3">Las Limitaciones y Riesgos (La Transparencia de TradeVision Latam)</h2>
    ...
    },
    {
        ...
        content: `
            ...
            <h2 class="text-2xl font-bold text-brand-primary dark:text-white mt-6 mb-3">Cómo Evitar el FOMO (El Método TradeVision Latam)</h2>
    ...
    },
    {
        ...
        excerpt: "Amara Srisuk (Experta en Psicotrading) analiza los arquetipos del trading (Toros, Osos, Ovejas, Ballenas) y cómo la disciplina de TradeVision Latam te ayuda a dominar tu \"zoológico\" interno.",
        ...
        content: `
            ...
            <p>En TradeVision Latam, nos enfocamos en la disciplina porque la mayoría de los traders minoristas no operan como Toros u Osos; operan como Gallinas y Ovejas.</p>
    ...
    },
    {
        ...
        content: `
            ...
            <ol class="list-decimal list-inside space-y-2 pl-4">
                <li><strong>Capacidad (La Estrategia):</strong> Tu conocimiento técnico. En TradeVision Latam, esto es el dominio del <a href="#/premium-courses" class="text-brand-accent hover:underline">Lenguaje del Precio</a> y la Lógica Institucional (SMC).</li>
            ...
            <p>No puedes dominar todos los mercados. Concéntrate en un concepto que entiendas y domínalo. En TradeVision Latam, nos enfocamos en la Lógica Institucional y el Lenguaje del Precio. Elige una temporalidad (ej. 1H, 4H) que puedas gestionar y aplica tu plan allí. La especialización construye confianza.</p>
    ...
    },
    {
        ...
        content: `
            ...
            <p>En el siglo XXI, la formación es vital, pero confundes "titulación" con "educación". En TradeVision Latam, valoramos la <strong>disciplina y la autoeducación</strong> por encima de un diploma colgado en la pared. La mayoría de los <em>traders</em> profesionales exitosos no tienen una formación financiera formal.</p>
            ...
            <p>Los grandes <em>traders</em> tienen grandes caídas. En TradeVision Latam, enseñamos que cada obstáculo (cada <em>stop loss</em> tocado) es una <strong>lección de datos</strong>, no una razón para renunciar. La única perfección que buscamos es la <strong>ejecución impecable de tu plan</strong>.</p>
            ...
            <p>El <em>trading</em> te da la libertad de adaptar tu estilo a tu vida. La próxima vez que uses una de estas excusas, entiende que solo son <strong>sesgos psicológicos</strong> que te impiden ejecutar. En TradeVision Latam, te damos las herramientas para romperlos.</p>
        `
    },
    {
        id: 16,
        ...
        excerpt: "Amara Srisuk, nuestra experta en Psicotrading, explica el sesgo de anclaje: la trampa psicológica que te hace aferrarte a operaciones perdedoras y cómo la disciplina de TradeVision Latam lo combate.",
        ...
        content: `
            ...
            <li><strong>Falta de Metodología (Pobre Investigación):</strong> Si entraste a una operación basándote en la opinión de un "gurú" de TikTok o una estimación promedio, tu "ancla" no tiene fundamentos reais. En TradeVision Latam, combatimos esto con análisis riguroso de la <a href="#/methodology" class="text-brand-accent hover:underline">Lógica Institucional (SMC)</a> y el Lenguaje del Precio.</li>
            </ol>
            <h2 class="text-2xl font-bold text-brand-primary dark:text-white mt-6 mb-3">Cómo Combatir el Anclaje (El Método TradeVision Latam)</h2>
            ...
            <p>En TradeVision Latam, fomentamos un <a href="#/acerca-de" class="text-brand-accent hover:underline">equipo global</a>. Escucha el análisis técnico de José Quintana, la perspectiva económica de <strong>Javier Solís</strong> (CEO) y la visión operativa de <strong>Lucas Almeida</strong> (Subdirector). Evita anclarte a una sola opinión (especialmente la tuya si estás perdiendo).</p>
    ...
    },
    {
        ...
        content: `
            ...
            <h2 class="text-2xl font-bold text-brand-primary dark:text-white mt-6 mb-3">¿Por Qué es Vital la Disciplina en TradeVision Latam?</h2>
            <ol class="list-decimal list-inside space-y-2 pl-4">
            ...
            <h2 class="text-2xl font-bold text-brand-primary dark:text-white mt-6 mb-3">Cómo Desarrollar la Disciplina (El Método TradeVision Latam)</h2>
            ...
            <p>Cualquiera que te prometa "ganancias garantizadas" o "scripts milagrosos" te está usando para aumentar sus propias ganancias. En TradeVision Latam, **prohibimos el lenguaje de "hágase millonario"**. No confíes en grandes palabras; confía en tu <em>backtesting</em> y en tu plan.</p>
    ...
    },
    {
        ...
        content: `
            ...
            <p>El apalancamiento es una herramienta, no un boleto de lotería. Un apalancamiento excesivo (como 1:1000) es innecesario y es la forma más rápida de quemar una cuenta. En TradeVision Latam, enseñamos a usarlo responsablemente, priorizando la gestión de riesgo sobre la ganancia potencial.</p>
...
`
    ...
    },
    {
        ...
        author: "Equipo TradeVision Latam",
        date: "28 Junio, 2024",
...
export const MENTORS: Mentor[] = [
    {
        ...
        bio: "Javier es el arquitecto de la visión de TradeVision Latam, fundada en 2018. Como economista financiero con sede en Madrid, su misión es profesionalizar el trading en LATAM, enfocándose en la ética, el cumplimiento regulatorio (Forex) y la creación de un ecosistema educativo sostenible.",
    ...
    },
    {
        ...
        bio: "Con más de 6 años de experiencia intensiva en los mercados más volátiles (Forex, Binarias y Cripto), José es la voz de la disciplina y la estrategia en TradeVision Latam. Su enfoque no es vender sueños, sino forjar traders rentables a través de la gestión de riesgo y una ejecución impecable.",
    ...
    },
    {
        ...
        bio: "Lucas lidera la expansión y las operaciones en el mercado de habla portuguesa. Experto en la Bolsa de Valores y estratega de crecimiento, asegura que la infraestructura de TradeVision Latam (comunidades, soporte) funcione con la eficiencia máxima y profesionalismo.",
...
export const COMPREHENSIVE_FAQS: ComprehensiveFAQ[] = [
    ...
    {
        category: "Ética de Afiliados (La Verdad)",
        question: "¿El programa de afiliados de TradeVision Latam es legal y transparente?",
    ...
    },
    {
        ...
        answer: "ADVERTENCIA DE RIESGO: Las plataformas de opciones binarias no están reguladas por entidades financieras internacionales y son consideradas altamente riesgosas. En TradeVision Latam, promovemos su uso principalmente con fines educativos y siempre bajo una estricta gestión del riesgo."
    },
    {
        category: "Brokers Recomendados",
